...
describe('createApolloStore', function () {
    ...
    it('throws an error if state contains a non-empty queries field', function () {
        ...
        assert.throws(function () { return store_1.createApolloStore({
            initialState: initialState,
        }); });
    });
    ...
    it('can reset itself and keep the observable query ids', function () {
        ...
        store.dispatch({
            ...
            queryId: 'test.0',
            queryString: '',
            document: (_a = [" query { abc }"], _a.raw = [" query { abc }"], graphql_tag_1.default(_a)),
            variables: {},
            forceFetch: false,
            returnPartialData: false,
            requestId: 1,
    ...
    it('can\'t crash the reducer', function () {
        ...
        var mutation = (_a = ["", ""], _a.raw = ["", ""], graphql_tag_1.default(_a, mutationString));
        var variables = {};
        store.dispatch({
