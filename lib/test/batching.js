"use strict";
var batching_1 = require("../src/transport/batching");
var chai_1 = require("chai");
var mockNetworkInterface_1 = require("./mocks/mockNetworkInterface");
var graphql_tag_1 = require("graphql-tag");
var networkInterface = mockNetworkInterface_1.mockBatchedNetworkInterface();
describe('QueryBatcher', function () {
    ...
    describe('request queue', function () {
        ...
        it('should be able to consume from a queue containing multiple queries', function (done) {
            ...
            var NI = mockNetworkInterface_1.mockBatchedNetworkInterface({
                request: { query: query },
                result: { data: data },
            }, {
                request: { query: query },
