...
describe('subscribeToMore', function () {
    ...
    it('triggers new result from subscription data', function (done) {
        ...
        var networkInterface = mockNetworkInterface_1.mockSubscriptionNetworkInterface([sub1], req1);
        var counter = 0;
    ...
    it('calls error callback on error', function (done) {
        var latestResult = null;
        var networkInterface = mockNetworkInterface_1.mockSubscriptionNetworkInterface([sub2], req1);
        var counter = 0;
        var client = new src_1.default({
            networkInterface: networkInterface,
            addTypename: false,
    ...
    it('prints unhandled subscription errors to the console', function (done) {
        var latestResult = null;
        var networkInterface = mockNetworkInterface_1.mockSubscriptionNetworkInterface([sub3], req1);
        var counter = 0;
        var client = new src_1.default({
            networkInterface: networkInterface,
            addTypename: false,
